            ...
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                        aria-expanded="false"><i data-feather="tag" class="feather-icon"></i><span
                            class="hide-menu">NPS y Encuestas </span></a>
                    <ul aria-expanded="false" class="collapse  first-level base-level-line">
                        <li class="sidebar-item"><a href="reporteNPS.php" class="sidebar-link"><span
                                    class="hide-menu"> Reporte NPS
                                </span></a>
                        </li>
                        <li class="sidebar-item"><a href="encuestas.php" class="sidebar-link"><span
                                    class="hide-menu"> Encuestas
                                </span></a>
                        </li>
                        <li class="sidebar-item"><a href="campanas.php" class="sidebar-link"><span
                                    class="hide-menu">
                                    Campañas
                                </span></a>
                        </li>
                ...
                <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                        aria-expanded="false"><i data-feather="file-text" class="feather-icon"></i><span
                            class="hide-menu">Padrones </span></a>
                    <ul aria-expanded="false" class="collapse  first-level base-level-line">
                        <li class="sidebar-item"><a href="clientes.php" class="sidebar-link"><span
                                    class="hide-menu"> Clientes
                                </span></a>
                        </li>
                        <li class="sidebar-item"><a href="grupoclientes.php" class="sidebar-link"><span
                                    class="hide-menu"> Grupo Clientes
                                </span></a>
                        </li>
                        <li class="sidebar-item"><a href="historial.php" class="sidebar-link"><span
                                    class="hide-menu"> Consulta Historial
                                </span></a>
                        </li>
                    </ul>
                </li>
